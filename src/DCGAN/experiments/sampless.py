...
batch_size = 128
num_epochs = 20
data_dir = '/home/jimmy/datastore/mnist'
save_dir = 'dump/result'
...
# Plot losses
# def plot_loss(d_losses, g_losses, num_epoch, save=False, save_dir='dump/copyget/loss', show=False):
#     fig, ax = plt.subplots()
...
#         # ax.imshow(img.view(image_size, image_size).data.numpy(), cmap='gray', aspect='equal')
